...
export const CustomerData = () => {
              ...
              <ul className="customer-list">
                {filteredCustomers.map((customer, index) => (
                  ...
                  >
                    ...
                    <p>
                      <strong>Total Lifetime Spend:</strong> ₹{getLifetimeOrderTotal(customer.phone).toFixed(2)}
                    </p>
  ...
  <div className="customer-orders">
    {(() => {
      ...
      const ordersByDate = customerOrders.reduce((group, order) => {
      ...
      return sortedDates.map((date, idx) => {
        ...
        return (
          <div key={idx} className="customer-order-date-group">
            <h4>Date: {date}</h4>
            <ul>
            ...
            <p>
              <strong>Total Price Spent on {date}:</strong> ₹{totalOnDate.toFixed(2)}
            </p>
          </div>
        );
      });
